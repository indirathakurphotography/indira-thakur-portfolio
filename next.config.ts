...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      ...
      {
        source: '/api/(gallery-images|films|video-testimonials|testimonials|about|services|site-config|faqs|dynamic-sections)',
        headers: [
          {
            key: 'Cache-Control',
      ...
      {
        source: '/api/(auth|contact|bookings|upload|cms-export|dashboard)/:path*',
        headers: [
          {
            key: 'Cache-Control',
