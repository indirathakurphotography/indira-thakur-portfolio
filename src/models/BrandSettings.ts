...
const BrandSettingsSchema = new Schema<IBrandSettings>(
  {
    ...
    tagline: { type: String, default: 'Fine Art Newborn, Maternity & Portraiture' },
...
export default (mongoose.models.BrandSettings as mongoose.Model<IBrandSettings>) || mongoose.model<IBrandSettings>('BrandSettings', BrandSettingsSchema);
