...
import { HiPhoto, HiCommandLine, HiUserGroup, HiStar, HiQuestionMarkCircle, HiCalendarDays, HiEnvelope, HiUser, HiClock, HiArrowRight, HiChartBar, HiPlus, HiBuildingStorefront } from 'react-icons/hi2';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4 flex-1">
            ...
            <a
              href="/admin/brands"
              onClick={(e) => { e.preventDefault(); window.location.href = '/admin/brands'; }}
              className="p-4 md:p-5 border border-cream/50 rounded-lg hover:bg-ivory/50 hover:border-magenta/30 transition-all group"
            >
              <div className="text-center">
                <div className="p-3 rounded-full bg-teal-100 text-teal-700 mx-auto mb-3 md:mb-4 group-hover:bg-teal-200 transition-colors">
                  <HiBuildingStorefront className="w-7 h-7 md:w-8 md:h-8" />
                </div>
                <span className="font-sans text-sm md:text-base font-medium text-rich-black">Brand Logos</span>
              </div>
            </a>
            <a
              href="/admin/gallery"
