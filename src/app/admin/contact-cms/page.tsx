      ...
      <div className="space-y-6">
        <Section title="Content" defaultOpen icon={<HiEnvelope className="w-5 h-5" />}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <FieldInput label="Location" value={c.location || ''} onChange={(v) => updateSection('contact', { location: v })} placeholder="Mumbai, Maharashtra, India" helperText="Your studio or city" />
          </div>
        </Section>
