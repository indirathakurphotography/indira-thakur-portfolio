...
const sidebarGroups: SidebarGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Testimonials', description: 'Public testimonial carousel', href: '/admin/testimonials', icon: HiUserGroup },
      { label: 'Review Records', description: 'External review source records', href: '/admin/reviews', icon: HiStar },
