...
export default function AdminFAQPage() {
  ...
  const defaultFaqs = [
    ...
    },
    {
      ...
      answer: 'Yes. Our studio features a hand-curated collection of organic hand-knit wraps, couture maternity dresses, silk drapes, and minimalist neutral studio props. You do not need to bring anything unless you have personal family heirlooms.'
    },
    {
      question: 'Where are sessions conducted?',
      answer: 'Sessions take place either in our serene, climate-controlled studio or on location at hand-selected outdoor scenic landscapes during golden hour.'
    },
    {
