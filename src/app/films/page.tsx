...
export default function FilmsPage() {
  ...
  return (
    <main className="pt-20 bg-[#FAF6F3]">
      ...
      <EditorialFilms />
      <AeoQuickAnswers
        title="Cinematography & Video Highlights Overview"
        subtitle="Learn about our 4K film production, music licensing, and delivery"
      />
    </main>
  );
}
